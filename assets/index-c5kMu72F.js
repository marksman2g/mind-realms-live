    ...
    <section class="hero-layout">
      ...
      <div class="scene-panel">
        ...
        <button
          ...
          aria-label="${O(`${e.label}: ${e.title}. ${e.detail}`)}"
        >
          <span>${O(e.label).replace(` `,`<br />`)}</span>
      ...
      `).join(``)}
        ...
        <div class="scene-caption">
          <span>${T.bodyForm===`female`?`Female`:`Male`} transparent anatomy frame</span>
...
`),oe=()=>{let e=l.filter(e=>e.status===`active`),t=l.filter(e=>e.status===`planned`),n=u(),r=e.map(e=>`
      ...
      <div class="two-column">
        ...
        <div class="panel">
          <div class="panel-inner">
            ...
            <div class="choice-grid">${re.map(e=>`<button class="choice-button ${T.secondaryGoal===e?`selected`:``}" data-secondary="${O(e)}">${O(e)}</button>`).join(``)}</div>
  ...
  `),I=()=>{let e=y[T.memory.round]??[],t=b.map(e=>`<button class="rune-button" data-rune="${e}">${e}</button>`).join(``),n=`Round ${Math.min(T.memory.round+1,y.length)} of ${y.length}`,r=``;return r=T.memory.phase===`intro`?`
  ...
  `)},L=()=>{let e=x[T.focus.index],t=``;return t=T.focus.phase===`intro`?`
      <div class="trial-surface">
        <div class="panel-inner">
  ...
  `)},le=()=>{let e=S[T.language.index],t=T.language.answers.length;return P(e?`
    <section class="screen">
      <div class="screen-header">
  ...
  `:`
    ...
    `)},R=()=>{let e=C[T.logic.index];return P(e?`
    <section class="screen">
      <div class="screen-header">
  ...
  `),B=()=>{let t=me(),n=e(pe()),r=n.domains.map(e=>`
  ...
  `)},V=()=>{let e=T.firstQuestComplete?`First quest complete. You improved the path by practicing one strategy immediately.`:`Ori chooses one guided quest from your strongest growth signal. This prototype simulates that first personalized lesson.`;return P(`
    <section class="screen">
      <div class="screen-header">
...
`);function U(){g.querySelectorAll(`[data-action]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.action;if(t===`next`&&k(),t===`reset`&&j(),t===`motion`&&(T.reducedMotion=!T.reducedMotion,D(`reduced_motion_toggled`,{enabled:T.reducedMotion}),$()),t===`go-report`&&A(`report`),t===`memory-start`&&G(),t===`memory-next-round`&&(T.memory.round+=1,G()),t===`focus-start`&&q(),t===`reread`&&(T.language.reread=!0,D(`language_reread_marked`),$()),t===`audio`&&(T.language.audio=!0,D(`audio_support_selected`),$()),t===`speak-subject-summary`&&ie(),t===`stop-subject-summary`&&M(),t===`topic-check`&&N(!1),t===`topic-deep`&&N(!0),t===`topic-clear`&&(T.topicNotice=void 0,T.topicDraft=``,$()),t===`complete-quest`&&(T.firstQuestComplete=!0,D(`first_quest_completed`,{path:Q()}),$()),t===`interest`){D(`pricing_interest_clicked`,{price:`$14.99/month`});let e=document.querySelector(`#interestNote`);e&&(e.textContent=`Interest captured for the prototype. Payment is not active yet.`)}})})}function W(){g.querySelectorAll(`[data-goal]`).forEach(e=>{e.addEventListener(`click`,()=>{T.primaryGoal=e.dataset.goal??``,D(`goal_selected`,{primaryGoal:T.primaryGoal}),$()})}),g.querySelectorAll(`[data-secondary]`).forEach(e=>{e.addEventListener(`click`,()=>{T.secondaryGoal=e.dataset.secondary??``,D(`secondary_goal_selected`,{secondaryGoal:T.secondaryGoal}),$()})});let e=g.querySelector(`#freeGoal`);e?.addEventListener(`input`,()=>{T.freeGoal=e.value});let t=g.querySelector(`#topicDraft`);t?.addEventListener(`input`,()=>{T.topicDraft=t.value}),g.querySelectorAll(`[data-body-form]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.bodyForm;t!==`male`&&t!==`female`||(T.bodyForm=t,D(`body_form_selected`,{bodyForm:t}),$())})});let n=Array.from(g.querySelectorAll(`[data-brain-region]`)),r=()=>{n.forEach(e=>e.classList.remove(`is-active`))};n.forEach(e=>{let t=()=>{r(),e.classList.add(`is-active`)};e.addEventListener(`pointerenter`,t),e.addEventListener(`focus`,t),e.addEventListener(`click`,e=>{e.preventDefault(),t()}),e.addEventListener(`pointerleave`,()=>{e.classList.remove(`is-active`)}),e.addEventListener(`blur`,()=>{e.classList.remove(`is-active`)})}),g.querySelectorAll(`[data-rune]`).forEach(e=>{e.addEventListener(`click`,()=>K(e.dataset.rune??``))}),g.querySelectorAll(`[data-focus-action]`).forEach(e=>{e.addEventListener(`click`,()=>J(e.dataset.focusAction===`tap`))}),g.querySelectorAll(`[data-focus-reflect]`).forEach(e=>{e.addEventListener(`click`,()=>{T.focus.reflection=e.dataset.focusReflect??``,T.focus.phase=`done`,D(`focus_pulse_completed`,{missedTargets:T.focus.missedTargets,decoyTaps:T.focus.decoyTaps,switchErrors:T.focus.switchErrors,reflection:T.focus.reflection}),$()})}),g.querySelectorAll(`[data-language]`).forEach(e=>{e.addEventListener(`click`,()=>ue(e.dataset.language??``))}),g.querySelectorAll(`[data-logic]`).forEach(e=>{e.addEventListener(`click`,()=>de(e.dataset.logic??``))}),g.querySelectorAll(`[data-feeling]`).forEach(e=>{e.addEventListener(`click`,()=>{T.reflection.feeling=e.dataset.feeling??``,D(`reflection_feeling_selected`,{feeling:T.reflection.feeling}),$()})}),g.querySelectorAll(`[data-strongest]`).forEach(e=>{e.addEventListener(`click`,()=>{T.reflection.strongest=e.dataset.strongest??``,D(`reflection_strength_selected`,{strongest:T.reflection.strongest}),$()})})}function G(){T.memory.phase=`show`,T.memory.input=[],T.memory.feedback=``,D(`trial_started`,{trial:`memory`,round:T.memory.round+1}),$(),window.setTimeout(()=>{T.screen===`memory`&&T.memory.phase===`show`&&(T.memory.phase=`answer`,$())},T.reducedMotion?500:1600)}function K(e){if(T.memory.phase!==`answer`)return;let t=y[T.memory.round]??[];if(T.memory.input.push(e),T.memory.input.length>=t.length){let e=0;t.forEach((t,n)=>{T.memory.input[n]===t?e+=1:T.memory.errorPositions.push(n+1)});let n=t.length-e;T.memory.correctPositions+=e,T.memory.totalPositions+=t.length,T.memory.round===1&&(T.memory.distractionErrors+=n),T.memory.round===2&&(T.memory.delayErrors+=n),D(`memory_sequence_completed`,{round:T.memory.round+1,correct:e,total:t.length}),T.memory.round>=y.length-1?T.memory.phase=`done`:(T.memory.phase=`feedback`,T.memory.feedback=n===0?`The sequence held cleanly. Ori will increase the load gently.`:`Part of the symbol chain faded. Ori is watching where the slip happened.`)}$()}function q(){T.focus.phase=`run`,T.focus.index=0,T.focus.presentedAt=Date.now(),D(`trial_started`,{trial:`focus`}),$()}function J(e){if(T.focus.phase!==`run`)return;let t=x[T.focus.index];if(!t)return;let n=t.target===e;T.focus.total+=1,n&&(T.focus.correct+=1),t.target&&!e&&(T.focus.missedTargets+=1),!t.target&&e&&(T.focus.decoyTaps+=1),t.afterSwitch&&!n&&(T.focus.switchErrors+=1),e&&T.focus.responseTimes.push(Date.now()-T.focus.presentedAt),T.focus.index+=1,T.focus.index>=x.length?T.focus.phase=`reflect`:T.focus.presentedAt=Date.now(),$()}function ue(e){let t=S[T.language.index];if(!t)return;let n=e===t.answer;T.language.answers.push({id:t.id,correct:n}),T.language.index+=1,D(`language_choice_made`,{id:t.id,correct:n}),$()}function de(e){let t=C[T.logic.index];if(!t)return;let n=e===t.answer;T.logic.answers.push({id:t.id,correct:n}),T.logic.index+=1,D(`logic_puzzle_completed`,{id:t.id,correct:n}),$()}function Y(){return(T.memory.totalPositions?T.memory.correctPositions/T.memory.totalPositions:0)>=.86?`Memory signal: your symbol recall held across load and delay.`:T.memory.distractionErrors>T.memory.delayErrors?`Memory signal: recall shifted most when the vault distracted you.`:T.memory.delayErrors>0?`Memory signal: first recall appeared stronger than delayed recall.`:`Memory signal: Ori needs more evidence, but sequence load should be trained gently.`}function X(){return T.focus.switchErrors>=2?`Focus signal: attention held early, but the rule switch pulled you back to the old pattern.`:T.focus.decoyTaps>=2?`Focus signal: action speed is strong. The next step is protecting accuracy before tapping.`:T.focus.missedTargets>=2?`Focus signal: some targets slipped during the pulse. Signal detection and re-centering should be trained.`:`Focus signal: your attention held through the pulse. Ori will check endurance over longer sessions later.`}function Z(){let e=T.language.answers.some(e=>e.id===`inference`&&!e.correct),t=T.language.answers.filter(e=>e.correct).length;return e?`Reading signal: direct details were clearer than hidden meaning. Inference should be trained next.`:t>=4?`Reading signal: direct detail, sequence, inference, and main idea all held in this short passage.`:`Reading signal: Ori needs more evidence across vocabulary, inference, and retention.`}function fe(){let e=T.logic.answers.filter(e=>!e.correct);return e.some(e=>e.id===`fraction`)?`Logic signal: patterns and balance may be ahead of visual fraction intuition.`:e.some(e=>e.id===`balance`)?`Logic signal: number patterns are waking up. Balance reasoning needs support.`:e.length===0?`Logic signal: pattern and balance reasoning were strong in this first forge run.`:`Logic signal: Ori will separate concept gaps from speed, reading load, and working memory.`}function pe(){let e=T.language.answers.filter(e=>e.correct).length,t=T.logic.answers.filter(e=>e.correct).length;return{goal:T.primaryGoal,secondaryGoal:T.secondaryGoal,freeGoal:T.freeGoal,reflectionFeeling:T.reflection.feeling,reflectionStrongest:T.reflection.strongest,memory:{correctPositions:T.memory.correctPositions,totalPositions:T.memory.totalPositions,delayErrors:T.memory.delayErrors,distractionErrors:T.memory.distractionErrors,errorPositions:T.memory.errorPositions},focus:{correct:T.focus.correct,total:T.focus.total,missedTargets:T.focus.missedTargets,decoyTaps:T.focus.decoyTaps,switchErrors:T.focus.switchErrors,responseTimes:T.focus.responseTimes},reading:{correct:e,total:T.language.answers.length,missedInference:T.language.answers.some(e=>e.id===`inference`&&!e.correct),reread:T.language.reread,audio:T.language.audio},math:{correct:t,total:T.logic.answers.length,missedFraction:T.logic.answers.some(e=>e.id===`fraction`&&!e.correct),missedBalance:T.logic.answers.some(e=>e.id===`balance`&&!e.correct)}}}function me(){return[{label:`Goal`,value:T.primaryGoal||`Become a super learner`},{label:`Memory`,value:Y().replace(`Memory signal: `,``)},{label:`Focus`,value:X().replace(`Focus signal: `,``)},{label:`Reading`,value:Z().replace(`Reading signal: `,``)},{label:`Logic`,value:fe().replace(`Logic signal: `,``)},{label:`Strategy`,value:he()},{label:`First path`,value:Q()},{label:`Daily time`,value:`12-15 minutes to start`}]}function he(){if(!T.reflection.strongest)return`Needs one reflection check.`;let e=_e(),t=Math.max(...Object.values(e)),n=e[T.reflection.strongest];if(n!==void 0&&t-n<=.05)return`Your self-read matched your strongest signal today.`;let r=ge();return`You felt strongest in ${T.reflection.strongest}, while Ori saw the strongest signal in ${r}.`}function ge(){let e=_e();return[[`Memory`,e.Memory],[`Focus`,e.Focus],[`Reading`,e.Reading],[`Math`,e.Math]].reduce((e,t)=>t[1]>e[1]?t:e)[0]}function _e(){return{Memory:T.memory.totalPositions?T.memory.correctPositions/T.memory.totalPositions:0,Focus:T.focus.total?T.focus.correct/T.focus.total:0,Reading:T.language.answers.length?T.language.answers.filter(e=>e.correct).length/T.language.answers.length:0,Math:T.logic.answers.length?T.logic.answers.filter(e=>e.correct).length/T.logic.answers.length:0}}function Q(){return T.focus.switchErrors>=2||T.focus.decoyTaps>=2?`Focus Recovery + Memory Anchors + Inference Clues`:T.memory.delayErrors>0||T.memory.distractionErrors>0?`Memory Anchors + Focus Pulse + Logic Patterns`:T.language.answers.some(e=>e.id===`inference`&&!e.correct)?`Inference Clues + Delayed Recall + Logic Patterns`:T.logic.answers.some(e=>!e.correct)?`Logic Forge Basics + Pace Control + Reading Clues`:`Advanced Recall + Flexible Focus + Transfer Quests`}function ve(){let e=Q();return e.startsWith(`Focus`)?`Steady Signal Quest`:e.startsWith(`Memory`)?`Memory Anchor Quest`:e.startsWith(`Inference`)?`Hidden Clue Quest`:e.startsWith(`Logic`)?`Balance Gate Quest`:`Transfer Trial Quest`}function ye(){let e=Q();return e.startsWith(`Focus`)?`You practice one breath before action, then repeat a shorter signal round where accuracy comes before speed.`:e.startsWith(`Memory`)?`You group symbols into anchors, replay them as a tiny story, then retrieve them after a short delay.`:e.startsWith(`Inference`)?`You compare what the scroll says directly with what it implies, then choose a path from the hidden clue.`:e.startsWith(`Logic`)?`You use a visual balance gate before seeing the number sentence, so the concept lands before notation.`:`You combine recall, focus, reading, and logic in one small mixed challenge.`}async function be(){let e=document.querySelector(`#brainScene`);if(e){E?.(),E=null;try{let t=await te(()=>import(`./three.module-kyxZOpvy.js`),[]);if(!document.body.contains(e))return;let n=new t.WebGLRenderer({alpha:!0,antialias:!0});n.setPixelRatio(Math.min(window.devicePixelRatio,2)),e.appendChild(n.domElement);let r=new t.Scene,i=new t.PerspectiveCamera(38,1,.1,100);i.position.set(0,-.42,7.6);let a=new t.Group;a.position.set(0,.34,0),a.scale.setScalar(.92),r.add(a);let o=new t.MeshStandardMaterial({color:8051682,emissive:1192763,roughness:.24,metalness:.02,transparent:!0,opacity:.075,depthWrite:!1}),s=new t.MeshStandardMaterial({color:15190667,emissive:3089424,roughness:.46,metalness:.04,transparent:!0,opacity:.095,depthWrite:!1}),c=new t.MeshStandardMaterial({color:16767352,emissive:16758861,roughness:.24,metalness:.18,transparent:!0,opacity:.84}),l=new t.MeshBasicMaterial({color:16314847,transparent:!0,opacity:.9,depthWrite:!1}),u=new t.MeshBasicMaterial({color:10482909,transparent:!0,opacity:.74,depthWrite:!1}),d=new t.MeshBasicMaterial({color:460041,transparent:!0,opacity:.92,depthTest:!1,depthWrite:!1}),f=new t.MeshBasicMaterial({color:16773311,transparent:!0,opacity:.55,depthTest:!1,depthWrite:!1}),p=new t.MeshBasicMaterial({color:6936750,transparent:!0,opacity:.26,depthWrite:!1}),ee=new t.MeshBasicMaterial({color:6936750,wireframe:!0,transparent:!0,opacity:.065,depthWrite:!1}),m=T.bodyForm===`female`,h=m?.82:1.02,g=m?.76:.56,_=m?[.86,.75,.52]:[1.05,.8,.56],ne=m?[.46,.78,.43]:[.68,.82,.48],re=[],v=e=>(re.push(e),a.add(e),e),y=(e,n,r)=>{let i=new t.Vector3(...e),a=new t.Vector3(...n),o=a.clone().sub(i),c=o.length(),l=new t.Mesh(new t.CapsuleGeometry(r,Math.max(.04,c-r*2),10,20),s);return l.position.copy(i.add(a).multiplyScalar(.5)),l.quaternion.setFromUnitVectors(new t.Vector3(0,1,0),o.normalize()),v(l)},b=(e,n,r=.012,i=a,o=42)=>{let s=new t.CatmullRomCurve3(e.map(e=>new t.Vector3(...e))),c=new t.Mesh(new t.TubeGeometry(s,o,r,8,!1),n);return i.add(c),c},x=(e,n,r,i=l,o=.5,s=.01)=>{let c=new t.Mesh(new t.TorusGeometry(o,s,10,96),i);return c.position.set(...e),c.scale.set(...n),c.rotation.set(...r),a.add(c),c},S=(e,t,n=.012,r=52)=>{b(e,t,n,a,r),b(e.map(e=>[-e[0],e[1],e[2]]).reverse(),t,n,a,r)},C=(e,t,n,r,i=.008,o=0,s=Math.PI*2,c=72)=>{let l=[];for(let r=0;r<=c;r+=1){let i=o+(s-o)*r/c;l.push([e[0]+Math.cos(i)*t,e[1]+Math.sin(i)*n,e[2]])}return b(l,r,i,a,c)},w=new t.Mesh(new t.SphereGeometry(.78,42,28),o);w.position.set(0,-.26,-.18),w.scale.set(..._),v(w);let D=new t.Mesh(new t.CapsuleGeometry(.42,.74,18,26),o);D.position.set(0,-.9,-.18),D.scale.set(...ne),v(D);let O=new t.Mesh(new t.SphereGeometry(.5,36,24),o);O.position.set(0,-1.42,-.14),O.scale.set(g*1.42,.44,.46),v(O);let k=new t.Mesh(new t.CapsuleGeometry(.18,.36,14,18),o);k.position.set(0,.52,-.08),k.scale.set(1,1,.65),v(k);let A=new t.Mesh(new t.SphereGeometry(.62,52,34),o);A.position.set(0,1.25,.02),A.scale.set(1.08,1.14,.9),v(A),y([-h,.22,-.08],[-1.42,.22,0],m?.065:.085),y([-1.42,.22,0],[-2.03,.2,.12],m?.058:.07),y([h,.22,-.08],[1.42,.22,0],m?.065:.085),y([1.42,.22,0],[2.03,.2,.12],m?.058:.07),y([-g*.45,-1.58,-.12],[-.33,-2.42,-.04],m?.085:.105),y([-.33,-2.42,-.04],[-.28,-3.14,.03],m?.064:.078),y([g*.45,-1.58,-.12],[.33,-2.42,-.04],m?.085:.105),y([.33,-2.42,-.04],[.28,-3.14,.03],m?.064:.078);let j=new t.Mesh(new t.SphereGeometry(.18,28,20),s);j.position.set(-2.1,.19,.15),j.scale.set(1.25,.34,.42),v(j);let ie=j.clone();ie.position.x=2.1,v(ie);let M=new t.Mesh(new t.SphereGeometry(.16,24,18),s);M.position.set(-.29,-3.22,.2),M.scale.set(1.22,.34,.62),v(M);let N=M.clone();if(N.position.x=.29,v(N),m){let e=new t.Mesh(new t.SphereGeometry(.65,38,24),s);e.position.set(0,1.22,-.12),e.scale.set(.92,1,.62),v(e)}x([0,1.26,.56],[1.08,1.14,.08],[0,0,0],l,.56,.012),x([-.55,1.25,.12],[.18,.28,.06],[0,Math.PI/2,0],u,.5,.006),x([.55,1.25,.12],[.18,.28,.06],[0,Math.PI/2,0],u,.5,.006),b([[-.35,.92,.6],[-.18,.78,.63],[0,.75,.65],[.18,.78,.63],[.35,.92,.6]],l,.01),b([[.02,1.45,.64],[.12,1.32,.71],[.05,1.19,.66]],u,.008),b([[-2.12,.22,.25],[-1.48,.26,.18],[-h,.25,.1],[-.42,.24,.02],[0,.18,.04],[.42,.24,.02],[h,.25,.1],[1.48,.26,.18],[2.12,.22,.25]],l,.016),b([[-h*.58,.18,.42],[-_[0]*.48,-.38,.46],[-g*.55,-1.17,.42],[-g*.74,-1.44,.34]],l,.014),b([[h*.58,.18,.42],[_[0]*.48,-.38,.46],[g*.55,-1.17,.42],[g*.74,-1.44,.34]],l,.014),b([[-.36,.02,.5],[-.18,-.04,.54],[0,-.06,.55],[.18,-.04,.54],[.36,.02,.5]],u,.008),b([[0,.06,.55],[0,-.35,.57],[0,-.82,.54],[0,-1.16,.48]],u,.008),[-.18,0,.18].forEach(e=>{b([[-.28,-.48+e,.56],[-.1,-.52+e,.59],[.1,-.52+e,.59],[.28,-.48+e,.56]],u,.006)}),b([[-.34,-1.48,.4],[-.45,-2.14,.35],[-.35,-2.86,.3],[-.31,-3.22,.32]],l,.012),b([[.34,-1.48,.4],[.45,-2.14,.35],[.35,-2.86,.3],[.31,-3.22,.32]],l,.012),x([-2.11,.2,.28],[.42,.16,.08],[0,0,0],l,.32,.008),x([2.11,.2,.28],[.42,.16,.08],[0,0,0],l,.32,.008),x([-.31,-3.23,.34],[.48,.16,.08],[0,0,-.05],l,.32,.008),x([.31,-3.23,.34],[.48,.16,.08],[0,0,.05],l,.32,.008);let P=.72,F=.755,ae=m?.92:1.08,oe=m?.62:.76,se=m?.38:.58,ce=m?.78:.62;C([0,1.3,P],.47,.6,l,.012,0,Math.PI*2,96),b([[-.28,1.43,F],[-.31,1.22,F],[-.22,1.05,F],[0,.97,F],[.22,1.05,F],[.31,1.22,F],[.28,1.43,F]],u,.007,a,46),C([-.49,1.28,P-.02],.06,.14,l,.006,0,Math.PI*2,36),C([.49,1.28,P-.02],.06,.14,l,.006,0,Math.PI*2,36),b([[0,1.48,F],[.06,1.35,.775],[.01,1.21,F]],u,.006),b([[-.17,1.14,F],[0,1.09,F],[.17,1.14,F]],u,.005),m?S([[-.34,1.83,P-.03],[-.53,1.55,P],[-.55,1.13,P],[-.36,.86,P]],u,.009,48):b([[-.32,1.65,F],[-.12,1.73,F],[.12,1.73,F],[.32,1.65,F]],u,.008),S([[-.18,.86,P],[-.23,.61,P],[-.45,.42,P],[-ae,.31,P]],l,.012,44),S([[-.14,.72,F],[-.3,.54,F],[-.58,.43,F],[-.88,.34,F]],u,.007,38),S([[-ae,.34,P],[-1.22,.31,P],[-1.62,.26,P],[-2.05,.22,P],[-2.34,.19,P]],l,.014,60),S([[-.82,.13,P],[-1.2,.11,P],[-1.62,.11,P],[-2.05,.13,P],[-2.33,.16,P]],l,.012,60),S([[-1.34,.3,F],[-1.43,.19,F],[-1.34,.1,F]],u,.005,24),[-1,1].forEach(e=>{C([e*2.39,.18,P],.17,.075,l,.007,0,Math.PI*2,34),[-.05,-.017,.017,.05].forEach(t=>{b([[e*2.27,.18+t,F],[e*2.49,.18+t*.85,F]],u,.004,a,12)})}),S([[-oe,.18,P],[-.6,-.18,P],[-se,-.76,P],[-.5,-1.08,P],[-ce,-1.42,P]],l,.015,58),b([[-.42,.12,F],[-.2,.02,F],[0,-.01,F],[.2,.02,F],[.42,.12,F]],u,.007,a,34),m?(C([-.24,-.13,F],.2,.12,u,.005,Math.PI*.05,Math.PI*1.02,34),C([.24,-.13,F],.2,.12,u,.005,Math.PI*-.02,Math.PI*.95,34)):b([[-.48,-.08,F],[-.2,-.16,F],[0,-.14,F],[.2,-.16,F],[.48,-.08,F]],u,.006),b([[0,.05,F],[0,-.38,F],[0,-.86,F],[0,-1.24,F]],u,.007),[-.12,-.38,-.64].forEach(e=>{b([[-.28,e,F],[-.1,e-.04,F],[.1,e-.04,F],[.28,e,F]],u,.005,a,28)}),b([[-.35,-1.18,F],[-.14,-1.38,F],[0,-1.48,F],[.14,-1.38,F],[.35,-1.18,F]],u,.006,a,32),S([[-ce*.58,-1.42,P],[-.58,-1.92,P],[-.54,-2.42,P],[-.42,-2.94,P],[-.34,-3.2,P]],l,.013,62),S([[-.16,-1.52,P],[-.19,-2.03,P],[-.18,-2.52,P],[-.22,-3.06,P]],l,.011,58),S([[-.45,-2.28,F],[-.34,-2.39,F],[-.22,-2.29,F]],u,.005,24),S([[-.24,-3.18,P],[-.52,-3.22,P],[-.62,-3.31,P],[-.4,-3.39,P],[-.18,-3.34,P]],l,.008,38),[-1,1].forEach(e=>{[-.08,-.02,.04].forEach(t=>{b([[e*.37,-3.29+t,F],[e*.6,-3.31+t*.5,F]],u,.0035,a,8)})}),re.forEach(e=>{let n=new t.Mesh(e.geometry,ee);n.position.copy(e.position),n.quaternion.copy(e.quaternion),n.scale.copy(e.scale).multiplyScalar(1.012),a.add(n)});let I=new t.Group;I.position.set(0,1.3,.62),I.rotation.set(-.04,-.18,.02),I.scale.setScalar(.82),a.add(I);let L=new t.Mesh(new t.SphereGeometry(.7,56,36),c),le=new t.Vector3(1.22,.78,.58);L.scale.copy(le),L.material.opacity=.08,I.add(L);let R=[],z=(e,n,r,i,a,o=.035)=>{let s=new t.MeshStandardMaterial({color:e,emissive:n,roughness:.36,metalness:.08,transparent:!0,opacity:.96}),c=new t.Mesh(new t.SphereGeometry(.34,48,30),s);return c.position.set(...r),c.scale.set(...i),I.add(c),R.push({mesh:c,phase:a,pulse:o,baseScale:i}),c};z(15952548,7280446,[-.42,.12,.08],[1.28,.86,.68],0),z(9098063,2975772,[.05,.29,0],[1.12,.75,.62],.7),z(16181340,7694870,[.16,.14,.2],[.38,.92,.34],1.25,.025),z(9402584,3154015,[-.16,-.23,.12],[1.16,.55,.62],1.8),z(6147297,1464426,[.48,.02,-.04],[.78,.73,.58],2.25),z(16749179,7548963,[.31,-.47,-.1],[.72,.38,.46],2.75,.018);let B=new t.Mesh(new t.CapsuleGeometry(.09,.5,14,22),new t.MeshStandardMaterial({color:16756876,emissive:6237730,roughness:.38,metalness:.04,transparent:!0,opacity:.94}));B.position.set(.36,-.72,-.08),B.rotation.z=-.18,I.add(B),R.push({mesh:B,phase:3.2,pulse:.012,baseScale:[1,1,1]});let V=new t.Mesh(new t.SphereGeometry(.12,28,18),new t.MeshStandardMaterial({color:16767352,emissive:8082709,roughness:.28,metalness:.12,transparent:!0,opacity:.95}));V.position.set(-.12,-.2,.44),V.scale.set(1.5,.5,.62),I.add(V),R.push({mesh:V,phase:3.8,pulse:.055,baseScale:[1.5,.5,.62]});let H=new t.Mesh(new t.SphereGeometry(.1,26,18),new t.MeshStandardMaterial({color:6936750,emissive:1530953,roughness:.25,metalness:.14,transparent:!0,opacity:.96}));H.position.set(-.5,.18,.43),H.scale.set(1.15,.82,.62),I.add(H),R.push({mesh:H,phase:4.2,pulse:.065,baseScale:[1.15,.82,.62]});let U=(e,t=d,n=.01,r=36)=>b(e,t,n,I,r);U([[-.76,.02,.29],[-.6,.38,.28],[-.2,.54,.24],[.28,.48,.17],[.68,.18,.1],[.64,-.12,.12],[.36,-.35,.16],[-.08,-.42,.24],[-.52,-.24,.3],[-.76,.02,.29]],f,.01,60),U([[.06,.52,.31],[.02,.32,.36],[.04,.12,.38],[.1,-.05,.36]],d,.011),U([[-.72,.27,.37],[-.52,.39,.41],[-.28,.32,.42],[-.14,.44,.39]]),U([[-.72,.08,.42],[-.5,.18,.45],[-.26,.1,.46],[-.08,.2,.43]]),U([[-.65,-.1,.4],[-.42,-.02,.46],[-.2,-.08,.48],[-.02,.03,.44]]),U([[-.52,-.29,.36],[-.26,-.22,.44],[0,-.28,.43],[.18,-.18,.35]]),U([[-.22,.5,.33],[.02,.4,.38],[.24,.44,.3],[.44,.3,.24]]),U([[.1,.29,.42],[.28,.23,.43],[.44,.14,.35],[.6,.03,.24]]),U([[.18,.02,.42],[.36,-.02,.4],[.5,-.13,.28],[.57,-.24,.16]]),U([[-.52,-.31,.3],[-.3,-.39,.37],[-.05,-.37,.36],[.18,-.43,.25]]),[-.16,-.08,0,.08].forEach(e=>{U([[.04,-.47+e,.27],[.24,-.43+e,.26],[.48,-.45+e,.12]],d,.006,22)});let W=new t.Mesh(new t.TorusGeometry(1.22,.008,12,110),p);W.position.set(-.2,.02,.42),W.rotation.set(Math.PI/2.35,.18,0),a.add(W);let G=W.clone();G.position.x=.2,G.rotation.y=-.18,a.add(G);let K=new t.Mesh(new t.TorusGeometry(1.72,.008,12,150),p);K.rotation.x=Math.PI/2,a.add(K);let q=new t.BufferGeometry,J=new Float32Array(540);for(let e=0;e<J.length;e+=3)J[e]=(Math.random()-.5)*4.8,J[e+1]=(Math.random()-.5)*4.2,J[e+2]=(Math.random()-.5)*3.4;q.setAttribute(`position`,new t.BufferAttribute(J,3));let ue=new t.Points(q,new t.PointsMaterial({color:15190667,size:.018,transparent:!0,opacity:.58}));r.add(ue),r.add(new t.AmbientLight(14602926,1.5));let de=new t.PointLight(16767352,4.2,10);de.position.set(2.6,3.2,3.4),r.add(de);let Y=new t.PointLight(6936750,2.3,9);Y.position.set(-2.8,.4,2.2),r.add(Y);let X=()=>{let t=e.getBoundingClientRect(),r=Math.max(1,t.width),a=Math.max(1,t.height);n.setSize(r,a,!1),i.aspect=r/a,i.updateProjectionMatrix()},Z=0,fe=new ResizeObserver(()=>{window.cancelAnimationFrame(Z),Z=window.requestAnimationFrame(X)});fe.observe(e),X();let pe=0,me=!0,he=0,ge=(e=0)=>{if(!me)return;he||=e;let t=e-he;if(!T.reducedMotion){let n=Math.sin(t*45e-5)*.58;a.rotation.y=n,I.rotation.y=-.18+Math.sin(t*6e-4+.8)*.08,L.scale.copy(le).multiplyScalar(1+Math.sin(e*.0022)*.035),R.forEach(({mesh:t,baseScale:n,phase:r,pulse:i})=>{let a=1+Math.sin(e*.0024+r)*i;t.scale.set(n[0]*a,n[1]*a,n[2]*a)}),W.rotation.z+=.003,G.rotation.z-=.003,K.position.y=-1.04+(Math.sin(e*.0017)+1)/2*2.55,ue.rotation.y-=.0015}n.render(r,i),pe=window.requestAnimationFrame(ge)};ge(),E=()=>{me=!1,window.cancelAnimationFrame(pe),window.cancelAnimationFrame(Z),fe.disconnect(),n.dispose(),q.dispose(),e.innerHTML=``}}catch{e.innerHTML=`
      <div class="scene-fallback">
        <div class="fallback-body" aria-label="Symbolic body and mind map"></div>
      </div>
    `}}}function $(){E&&=(E(),null);let e={intro:F,ori:ae,subjects:oe,goals:se,realms:ce,memory:I,focus:L,language:le,logic:R,reflection:z,report:B,quest:V,path:H}[T.screen];g.innerHTML=e(),U(),W(),T.screen===`intro`&&be()}D(`onboarding_started`),$();